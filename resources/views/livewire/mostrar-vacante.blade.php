<div class="p-10">
    ...
    {{-- Vista para poder postularse a la vacante --}}
    {{-- Guest se usa para usuarios no autenticados --}}
    @guest
        <div class="mt-5 bg-gray-50 border border-dashed p-5 text-center">
            <p>
                Deseas aplicar a esta vacante? 
                <a class="font-bold text-indigo-700" 
                href="{{route('register')}}">Obten una cuenta y aplica a esta y otras vacantes</a>
            </p>
        </div>
    @endguest
    
    {{-- cannot indica que si no puede crear un modelo es el usuario contrario en este caso postulante --}}
