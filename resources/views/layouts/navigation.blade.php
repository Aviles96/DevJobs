    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                @auth
                    {{-- El usuario puede crear vacantes --}}
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                {{-- Ensenar si hay notificaciones pendientes --}}
                @auth
                {{-- El usuario puede crear vacantes --}}
                   @can('create', App\Model\Vacante::class)
                        <a href="{{route('notificaciones')}}"
                            class="mr-2 w-7 h-7 bg-indigo-600 hover:bg-indigo-800 rounded-full flex flex-col
                ...
                {{-- Guest Cuando el usuario no esta autenticado --}}
                @guest
                <!-- Navigation Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        @auth
            <div class="pt-2 pb-3 space-y-1">
                ...
                {{-- Aparesca las notificaciones en tamano movil --}}
                @if (auth()->user()->rol === 2)
                    <div class="flex gap-2 items-center p-3">
                        ...
                        <p class="text-base font-medium text-gray-600">
                            {{-- Con choice va tomar auth-user-unreadNotificatons y revisar si es en plural o singular --}}
